...
import numpy as np
from utils.config import COMBINATIONS, AVG_POT_SIZE, PLAYER_CHIPS
...
if __name__ == "__main__":
    ...
    pkl.dump(data, open("datastage1.pkl", "wb"))
    ...
    torch.save(train_dataset, f"data/{stage.name}/data_tensor{random_hash}.pt")
