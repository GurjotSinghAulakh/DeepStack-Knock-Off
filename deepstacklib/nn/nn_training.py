...
from deepstacklib.state.state_manager import PokerGameStage
from deepstacklib.nn.nn_model import DeepstackNN
from deepstacklib.utils.config import COMBINATIONS
from deepstacklib.data.datagen import PokerDataModule
...
class NNTrainer:
    ...
    def train_network(self, stage: PokerGameStage, max_epochs: int = 100, data_size: int = 100) -> None:
        ...
        trainer = Trainer(max_epochs=max_epochs, default_root_dir=f"./deepstacklib/nn/lightning_logs/{stage.name}", devices=-1)
