...
RESOLVER_ROLLOUTS = 10              # Number of rollouts to perform in the resolver
RESOLVER_CHILDREN_ACTION_LIMIT = 2  # Number of children to consider in the resolver
RESOLVER_N_CHILD_STATES = 2          # Number of child states to consider in the resolver
