...
from deepstacklib.state.state_manager import StateManager, GameState, PokerGameStage
from deepstacklib.clients.actions import ActionType, Action, ACTIONS, agent_action_index
from deepstacklib.utils.config import COMBINATIONS, RESOLVER_ROLLOUTS
from deepstacklib.clients.resolver import Resolver
...
class Player:
    ...
    def take_action(self, state: GameState) -> Action:
        ...
        if self.agent_type == "random":
            ...
            act_type = self.choose_action(legal_actions, state)
