...
import random
from deepstacklib.utils.config import BASE_CARDS, COMBINATIONS, SUITS
import numpy as np
import os
...
class PokerOracle:
    ...
    def get_cheat_sheet(self, n_simulations: int = 1000, cheat_path: str = './deepstacklib/data/cheating/cheat_sheet.csv') -> pd.DataFrame:
        """
